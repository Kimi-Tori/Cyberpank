<template>
    <section class="home-intro position-relative">
      <div class="position-relative">
        <swiper :navigation="false" :pagination="{clickable: false}" :modules="modules" v-bind="swiperOptions">
          <swiper-slide v-for='item in slide' :key='item.src' class="d-flex justify-center align-center h-100 w-100 overflow-hidden">
  ...
  // Импорт изображений
  import img1 from '@/assets/home/home-intro-desktop-1.jpg';
  import img2 from '@/assets/home/home-intro-desktop-2.jpg';
  import img3 from '@/assets/home/home-intro-desktop-3.jpg';
